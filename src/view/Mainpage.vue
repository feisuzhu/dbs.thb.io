...
<link href="jessica/css/prettyPhoto.css" rel="stylesheet" type="text/css" />
<link rel="stylesheet" id="camera-css"  href="jessica/css/camera.css" type="text/css" media="all">
<link href="jessica/css/bootstrap.css" rel="stylesheet">
<link href="jessica/css/theme.css" rel="stylesheet">
<link rel="stylesheet" type="text/css" href="css/skins/tango/skin.css" />
<link href="jessica/css/bootstrap-responsive.css" rel="stylesheet">
<!--[if lt IE 9]>
    ...
    <div class="page_container">
        ...
        <div id="main_slider">
            <div class="camera_wrap" id="camera_wrap_1">
                <div data-src="jessica/img/slider/1.jpg"></div>
                <div data-src="jessica/img/slider/2.jpg"></div>
                <div data-src="jessica/img/slider/3.jpg"></div>                                        
            </div><!-- #camera_wrap_1 -->
            <div class="clear"></div> 
        </div>        
        <!--//slider-->
              ...
              <div class="row">
                    <div class="span12">
                        <ul id="mycarousel" class="jcarousel-skin-tango">
                            <li>
                              <div class="hover_img">
                                  <a href="jessica/img/featured_works/1.jpg" rel="prettyPhoto[portfolio1]"><img src="jessica/img/featured_works/1.jpg" alt="" /><span class="portfolio_zoom1"></span></a>                                    
                                </div>
                            </li>
                            <li>
                              <div class="hover_img">
                                  <a href="jessica/img/featured_works/2.jpg" rel="prettyPhoto[portfolio1]"><img src="jessica/img/featured_works/2.jpg" alt="" /><span class="portfolio_zoom1"></span></a>                                    
                                </div>
                            </li>
                            <li>
                                <div class="hover_img">
                                  <a href="jessica/img/featured_works/3.jpg" rel="prettyPhoto[portfolio1]"><img src="jessica/img/featured_works/3.jpg" alt="" /><span class="portfolio_zoom1"></span></a>                                    
                                </div>
                            </li> 
                            <li>
                                <div class="hover_img">
                                  <a href="jessica/img/featured_works/4.jpg" rel="prettyPhoto[portfolio1]"><img src="jessica/img/featured_works/4.jpg" alt="" /><span class="portfolio_zoom1"></span></a>                                    
                                </div>
                            </li>
                            <li>
                              <div class="hover_img">
                        ...
                        <ul id="mycarousel2" class="jcarousel-skin-tango">
                            <li>
                              <div class="post_carousel">
                                  <img src="jessica/img/home_blog/1.jpg" alt="" />
                            ...
                            <li>
                              <div class="post_carousel">
                                  <img src="jessica/img/home_blog/2.jpg" alt="" />
                            ...
                            <li>
                              <div class="post_carousel">
                                  <img src="jessica/img/home_blog/3.jpg" alt="" />
                            ...
                            <li>
                              <div class="post_carousel">
                                  <img src="jessica/img/home_blog/4.jpg" alt="" />
                                  <div class="title_t"><a href="#">ipsum dolor ac egestas mas</a></div>
                                    <div class="post_meta">
                                    Posted by <a href="#">John Doe</a>  /  15 apr  / In <a href="#">Vacation</a>
                                    </div>
