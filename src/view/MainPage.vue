        ...
        <div class="wrap block carousel_block">
            <div class="container">
                ...
                <div class="row mainpage-carousel">
                    <Slick>
                        <div class="hover_img">
                            <img :src="require('jessica/img/featured_works/1.jpg')" alt="" /><span class="portfolio_zoom1"></span>
                        </div>
                        <div class="hover_img">
                            <img :src="require('jessica/img/featured_works/2.jpg')" alt="" /><span class="portfolio_zoom1"></span>
                        </div>
                        <div class="hover_img">
                            <img :src="require('jessica/img/featured_works/3.jpg')" alt="" /><span class="portfolio_zoom1"></span>
                        </div>
                        <div class="hover_img">
                            <img :src="require('jessica/img/featured_works/4.jpg')" alt="" /><span class="portfolio_zoom1"></span>
                        </div>
                        <div class="hover_img">
                            <img :src="require('jessica/img/featured_works/3.jpg')" alt="" /><span class="portfolio_zoom1"></span>
                        </div>
